...
wait(0.2)
	game.StarterGui:SetCore("SendNotification", {
		Title = "Zumi Kaitun Hub ", 
		Text = "Wellcome to ZUMI  x Hub Premium Script",
		Icon = "http://www.roblox.com/asset/?id=14334760790",
		Duration = 2
	})
	wait(0.1)
...
local library = {
	WorkspaceName = "ZUMI  X HUB KAITAN SERISE X",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
...
local PepsiUi = library:CreateWindow({
    Name = "Zumi Hub Kaitun",
    Theme = {
        Image = "rbxassetid://7483871523",
        Info = "Zumi Hub Kaitun",
        Background = {
